...
class VisualizerPlugin : MethodChannel.MethodCallHandler {
    ...
    // Updated by Visualizer callback (background thread); read by Dart poll (main thread).
            ...
            visualizer = Visualizer(sessionId).apply {
                ...
                setDataCaptureListener(object : Visualizer.OnDataCaptureListener {
                    ...
                    override fun onFftDataCapture(v: Visualizer, fft: ByteArray, r: Int) {
                        val n = bins.size
                        // fft[0] = DC (real only), fft[1] = Nyquist (real only)
                        // fft[2k], fft[2k+1] = re, im of bin k (k = 1..n-1)
